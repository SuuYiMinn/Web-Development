...
<div class="p-4 sm:ml-64">
    <div class="flex justify-between mb-3">
        <p class="text-2xl font-semibold opacity-70">Drug List </p>
        <a href="/drug/create" class="mr-5 bg-blue-500 px-2 py-2 rounded-lg text-white">Add Drug</a>
    </div>
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white dark:bg-gray-800">
                ...
                <td class="px-6 py-4">
                  <span>$</span> {{ $drug->d_price }} <span>/per Item</span>
                </td>
...
<div class="mt-10 flex p-10 justify-center">
    {{ $drugs->links("pagination::tailwind") }}
</div>
